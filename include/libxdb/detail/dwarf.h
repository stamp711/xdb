// The content of this file is copied from /usr/include/dwarf.h on an Archlinux install @2025-12-27
// NOLINTBEGIN
...
enum { DW_ACCESS_public = 1, DW_ACCESS_protected = 2, DW_ACCESS_private = 3 };

/* DWARF visibility encodings.  */
enum { DW_VIS_local = 1, DW_VIS_exported = 2, DW_VIS_qualified = 3 };

/* DWARF virtuality encodings.  */
enum { DW_VIRTUALITY_none = 0, DW_VIRTUALITY_virtual = 1, DW_VIRTUALITY_pure_virtual = 2 };
...
enum { DW_ID_case_sensitive = 0, DW_ID_up_case = 1, DW_ID_down_case = 2, DW_ID_case_insensitive = 3 };
...
enum { DW_INL_not_inlined = 0, DW_INL_inlined = 1, DW_INL_declared_not_inlined = 2, DW_INL_declared_inlined = 3 };

/* DWARF ordering encodings.  */
enum { DW_ORD_row_major = 0, DW_ORD_col_major = 1 };

/* DWARF discriminant descriptor encodings.  */
enum { DW_DSC_label = 0, DW_DSC_range = 1 };

/* DWARF defaulted member function encodings.  */
enum { DW_DEFAULTED_no = 0, DW_DEFAULTED_in_class = 1, DW_DEFAULTED_out_of_class = 2 };
